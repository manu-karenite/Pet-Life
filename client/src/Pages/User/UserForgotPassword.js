      ...
      <div className="row" style={{ padding: "0px !important" }}>
        <div className="col-md-12">
          <div>
            {otpSent === "first" && (
              <center>
              <div style={{backgroundColor: "", padding: "25px", margin: "40px 0px",border: "2px solid #121916", width:"50%"}}>
                <center>
                  <h2><b>Forgot Password?</b></h2>
                  <h9><b>Reset Your Password Here</b></h9>
                  <form onSubmit={submitHandler}>
                    <center>
                      <input
                        ...
                        value={email}
                        style={{width: "60%",border: "2px solid #121916", textAlign: "center", margin: "10px 0px",borderTopLeftRadius: "10px",borderBottomRightRadius: "10px"}}
                      />
                      <br></br>
                      <input
                        type="submit"
                        value="Reset Password"
                        style={{width: "30%",backgroundColor: "#121916", color: "white", border: "1px solid #121916", margin: "10px 0px", }}
                      />
                    </center>
                  </form>
                  <div>
                    <b>Want to Login? <Link to="/login">Login Here</Link></b>
                  </div>
                </center>
              </div>
              </center>
            ...
            {otpSent === "second" && (
              ...
              <div style={{backgroundColor: "", padding: "25px", margin: "40px 0px",border: "2px solid #121916", width:"50%"}}>
                <center>
                  <h2><b>Enter OTP</b></h2>
                  <h9><b>We've sent an OTP to {email}</b></h9>
            ...
            {otpSent === "third" && (
              ...
              <div style={{backgroundColor: "", padding: "25px", margin: "40px 0px",border: "2px solid #121916", width:"50%"}}>
                <center>
                  <h2><b>Create Password</b></h2>
                  <h9><b>Please remember this password</b></h9>
