            ...
            <div className="terms-body">
              <div className="outer">
                <div className="question">
                  What is your minimum age when accepting a dog for boarding or
                  daycare?
                </div>
              ...
              <div className="outer">
                ...
                <div className="answer">
                  We offer discounts for each pet for both daycare and boarding
                  services, as per Hotel Concerned has to Offer.
                </div>
              </div>
              <div className="outer">
                <div className="question">
                  while my pet is boarding with you, will they be taken out for
                  walks?
                </div>
                <div className="answer">
                  Yes, we do take pets outside of our hotel if, the feature is
                  present in the service being offered, subject to environmental
                  features.
                </div>
              </div>
              <div className="outer">
