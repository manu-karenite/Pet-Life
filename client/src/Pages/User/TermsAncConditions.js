            ...
            <div className="terms-body">
              ...
              <p>
                <ol>
                  ...
                  <li>
                    Owners must apply a tick & flea treatment such as Frontline
                    before checking in their pet, to ensure that the pet is free
                    of external parasites. Otherwise we will apply this
                    treatment and charge the cost to owners.
                  </li>
                  <li>
                    Pet Owners shall produce their pet’s current or most recent
                    Vaccination Certificate from a qualified and certified
                    veterinarian. The Vaccination Certificate shall not be more
                    than 12 months old from the date of boarding.
                  </li>
                  <li>
              ...
              <p>
                ...
                <ol start="5">
                  ...
                  <li>
                    Provide a reasonably safe environment for the pet subject to
                    Pet Owner’s warranty that the pet does not and will not pose
                    a danger or risk (whether physical or by way of transmission
                    of disease or parasites) to other pets at{" "}
                    <i>Pet Life &copy;</i>;
                  </li>
                  <li>
              ...
              <ol start="5">
                <li>
                  ...
                  <ol start="A">
                    <li>
                      Contact the Pet Owner to collect the pet if the Pet Owner
                      is contactable;
                    </li>
                    <li>
                ...
                <li>
                  ...
                  <i>Pet Life &copy;</i> and further agrees not to hold or make{" "}
                  <i>Pet Life &copy;</i> liable for any injury or illness or
                  death to the Affected Pet.
                </li>
                <li>
                  Pet Owner also waives all rights and claims against{" "}
                  <i>Pet Life &copy;</i>
                  and further agrees not to hold or make <i>
                    Pet Life &copy;
                  </i>{" "}
                  liable for any step or action or thing or decision made or
                  taken by Pet Hotel concerning the Affected Pet.
                </li>
                <li>
                  Maintain the pet in good health as far as reasonably possible
                  and to the best of <i>Pet Life &copy;</i>’s abilities subject
                  to Pet Owner’s fulfilment of the mandatory conditions in 1
                  above.
                </li>
              </ol>
              <hr />
